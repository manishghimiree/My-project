...
if(isset($_POST['submit'])){
    ...
    move_uploaded_file($temp_name1,"image/product_images/$product_img1");
    move_uploaded_file($temp_name2,"image/product_images/$product_img2");
    move_uploaded_file($temp_name3,"image/product_images/$product_img3");
